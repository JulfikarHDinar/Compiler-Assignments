        ...
        while( (c = fgetc(source)) != EOF ){
            ...
            if (forStat == 0){
                if(c == '('){
                    ...
                    if( isempty(parStack)) {
                        printf("Misplaced Parenthesis ')' at line: %d,", lineNo);
                        printf("\n");
                    }
                    else{
                        pop(parStack);
                    ...
                    if( !isempty(parStack)) {
                        printf("Misplaced Parenthesis '(' at line: ");
                        printStack(parStack);
                        printf("\n");
    ...
    if(source == NULL || target == NULL){
        ...
        while( (c = fgetc(source)) != EOF ){
            ...
            if(c == '{'){
                ...
                if( isempty(brcStack)) {
                    printf("Misplaced Curly Brace '}' at line: %d,", lineNo);
                    printf("\n");
                }
                else{
                    pop(brcStack);
        ...
        if( !isempty(brcStack)) {
            printf("Misplaced Curly Brace '{' at line: ");
            printStack(brcStack);
            printf("\n");
        }
    }
...
int main(){
    ...
    char sourceFileName_0[30] = "Input_Q2.txt";
    ...
    ///  printing in console
    char c;
    target = fopen (sourceFileName_0,"r");
